...
const Register = () => {
    ...
    const { register } = useAuth(); // Assuming context has register now, or use axios directly
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await register(username, email, password); // Use the register function from context
            navigate('/');
        } catch (err) {
